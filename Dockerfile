...
RUN mvn install:install-file -Dfile=libs/core-0.3.17.jar -DgroupId=com.looksee -DartifactId=core -Dversion=0.3.17 -Dpackaging=jar
...
EXPOSE 443
EXPOSE 80
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom", "-Xms512M", "-ea","-jar", "app.jar"]
