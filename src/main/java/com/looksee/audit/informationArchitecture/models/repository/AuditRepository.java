...
public interface AuditRepository extends Neo4jRepository<Audit, Long> {
	...
	@Query("MATCH (audit:Audit) WHERE id(audit)=$audit_id MATCH (msg:UXIssueMessage) WHERE id(msg) IN $issue_ids MERGE audit_issue=(audit)-[:HAS]->(msg) RETURN audit LIMIT 1")
