package com.looksee.audit.informationArchitecture.models.dto;

import com.looksee.audit.informationArchitecture.models.enums.ExecutionStatus;

/**
 * Data transfer object representing progress and scores for a page audit 
 * that is designed to comply with the data format for browser extensions
 */
